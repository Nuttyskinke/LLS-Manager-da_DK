const modules = {
	appstore: {
		...
		Nulstil: 'Nulstill',
		noMapkit:
			'Dette modul fungerer ikke med korttypen "Mapkit" på grund af begrænsninger i Mapkit!',
		dev: 'Dette modul er stadig under udvikling. Aktivering af den kan føre til ufuldstændige og fejlbehæftede funktioner!',
		closeWarning: {
			title: 'Der er ændringer som ikke er gemt',
			text: 'Du har lavet ændringer i AppStore, som endnu ikke er blevet gemt. Nulstil dem eller gem dem for at lukke AppStore.',
			abort: 'Annullere',
			saveAndExit: 'Gem og luk',
			exit: 'Luk uden at gemme',
		},
	},
	Indstillinger: {
		name: 'Indstillinger',
		...
		export: 'Export',
		import: 'Import',
		donate: 'Donere - Frivilligt',
		appendableList: {
			unique: {
				title: 'Dobbelt værdi',
				text: 'Der må ikke være duplikerede værdier i kolonnen **{title}**. Værdien **{value}** findes allerede!',
				confirm: 'OK',
			},
		},
		resetWarning: {
			title: 'Nulstill Indstillinger',
			text: 'Vil du virkelig nulstille indstillingerne til deres standardværdier? Dette kan ikke fortrydes!',
			close: 'Annullere',
			total: 'Alle Indstillinger',
			module: 'Kun fra dette modul',
		},
		resetWarningSetting: {
			title: 'Nulstill Indstillinger',
			text: 'Vil du virkelig nulstille denne ene indstilling <b>{setting}</b> for modulet <b>{module}</b> til standardværdien?',
			close: 'Annullere',
			Nulstil: 'Nulstil',
		},
		closeWarning: {
			title: 'Der er ændringer som ikke er gemt',
			text: 'Du har foretaget ændringer i Indstillinger, som endnu ikke er gemt. Nulstil dem, kasser dem eller Gem dem for at lukke Indstillingerne.',
			abort: 'Annullere',
			saveAndExit: 'Gem og luk',
			exit: 'Luk uden at gemme',
		},
		...
		locationSelect: {
			location: 'Vælg position',
			zoom: 'Vælg position og zoom',
			sync: 'bruge nuværende position',
		},
	},
...
export default {
	...
	vehicles: {
		...
		26: {
			...
			possibleBuildings: [0, 18],
			special:
				'Unlocked at Fire Apparatus Operator or Sergeant Rank. Works as a Water Carrier and Water Ladder. Used in rural areas to Gem money.',
		},
		27: {
			caption: 'PRV',
			color: '#99631f',
